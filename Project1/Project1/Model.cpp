...
//------------------------------------------------------------------------------------------------------
void Model::SetTexture(const GLuint textureID)
{
	m_texture.Set_ID(textureID);
...
void Model::SetUp(GLfloat x, GLfloat y, GLfloat z)
{
	m_up_vec = glm::vec3(x, y, z);
}

void Model::SetRight(GLfloat x, GLfloat y, GLfloat z)
{
	m_right_vec = glm::vec3(x, y, z);
}

void Model::SetForward(GLfloat x, GLfloat y, GLfloat z)
{
	m_forward_vec = glm::vec3(x, y, z);
}
...
//------------------------------------------------------------------------------------------------------
void Model::UnloadTexture(const GLuint textureID)
{
...
void Model::Update()
{
	...
	m_model = glm::rotate(m_model, glm::radians(m_rotation.x), m_right_vec);
	m_model = glm::rotate(m_model, glm::radians(m_rotation.z), m_forward_vec);
	m_model = glm::rotate(m_model, glm::radians(m_rotation.y), m_up_vec);
